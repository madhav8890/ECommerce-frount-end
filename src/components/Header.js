          ...
          <div className="row">
            ...
            <div className="col-6">
              <p className="text-end text-white mb-0">
                Mobile:
                <a className="text-white" href="tel:+91 8109168890">
                  +91 8109168890
                </a>
              </p>
            </div>
      ...
      <header className="header-upper py-3">
        <div className=" container-xxl">
          <div className="row align-items-center">
            <div className="col-2">
              <Link className="text-white h2 ">Baleja.com</Link>
            </div>
            <div className="col-5">
            ...
            <div className="col-5">
              <div className="header-upper-links d-flex align-items-center justify-content-between">
                ...
                <div>
                  <Link to='/widhlist' className="d-flex align-items-center gap-1 text-white">
                    <img src="/images/wishlist.svg" alt="wishlist" />
                    <p className="mb-0">Faverate <br /> Wishlist</p>
                  </Link>
                </div>
                <div>
              ...
              <div className="menu-bottom d-flex align-items-center gap-30">
                ...
                <div className="menu-links">
                  <div className="d-flex align-items-center gap-15">
                    ...
                    <NavLink to="/store">Our Stors</NavLink>
